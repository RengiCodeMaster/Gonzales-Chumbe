...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "bg-brand-primary text-white hover:bg-brand-secondary shadow-md border border-transparent",
    dark: "bg-brand-dark text-white hover:bg-brand-primary shadow-md border border-transparent",
    white: "bg-white text-brand-dark hover:bg-brand-accent border border-brand-border shadow-sm",
    outline: "border border-brand-primary text-brand-primary hover:bg-brand-primary hover:text-white",
    text: "text-brand-primary hover:text-brand-secondary hover:bg-brand-accent/10 px-4 normal-case tracking-normal"
  };
