            ...
            <div className="container mx-auto px-6 lg:px-12 relative z-10 text-center">
                <Reveal width="100%">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6 tracking-tight leading-tight">
                        Su libertad y su patrimonio <br /> <span className="text-brand-primary">no pueden esperar.</span>
                    </h2>
                </Reveal>
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-6">
                    <Reveal delay={400} width="fit-content">
                        <Link to="/contacto" className="inline-flex items-center justify-center px-8 py-4 bg-brand-primary hover:bg-white hover:text-brand-dark text-white font-bold text-sm uppercase tracking-widest rounded-sm transition-all shadow-lg hover:shadow-xl group min-w-[200px]">
                    ...
                    <Reveal delay={500} width="fit-content">
                        <a href="tel:+51954857599" className="inline-flex items-center justify-center gap-3 text-white hover:text-brand-primary transition-colors font-serif-accent text-lg border-b border-white/20 hover:border-brand-primary pb-1">
                            <PhoneCall size={20} />
